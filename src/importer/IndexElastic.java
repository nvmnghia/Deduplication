        ...
        while (articleSet.next()) {
            ...
            bulkRequest.add(client.prepareIndex(Config.ES.INDEX, "articles", String.valueOf(counter++))
                    .setSource(jsonBuilder()
                            ...
                            .field("affiliation", StringUtl.correct(StringUtl.normalizeSpaces(articleSet.getString(2))))
                            .field("author", StringUtl.normalizeSpaces(articleSet.getString(3)))
                            .field("doi", articleSet.getString(4))
                            .field("issn", StringUtl.normalizeISSN(articleSet.getString(7)))
                            .field("journal", StringUtl.normalizeSpaces(articleSet.getString(8)))
                            .field("journal_iso", StringUtl.normalizeSpaces(articleSet.getString(9)))
                            .field("language", articleSet.getString(10))
                            .field("pages", articleSet.getString(11))
                            .field("publisher", articleSet.getString(12))
                            .field("title", StringUtl.normalizeSpaces(articleSet.getString(13)))
                            ...
                            .field("abstract", StringUtl.normalizeSpaces(articleSet.getString(19)))
                            .field("reference", articleSet.getString(20))
                            .field("number", articleSet.getString(21))
                            .field("keyword", StringUtl.normalizeSpaces(articleSet.getString(22)))
                            .field("is_isi", true)
        ...
        while (articleSet.next()) {
            ...
            bulkRequest.add(client.prepareIndex(Config.ES.INDEX, "articles", String.valueOf(counter++))
                    .setSource(jsonBuilder()
                            .startObject()
                            .field("original_id", articleSet.getInt(1))
                            .field("affiliation", StringUtl.correct(StringUtl.normalizeSpaces(articleSet.getString(10))))
                            .field("author", StringUtl.normalizeSpaces(articleSet.getString(2)))
                            ...
                            .field("journal", StringUtl.normalizeSpaces(articleSet.getString(5)))
                            .field("journal_iso", StringUtl.normalizeSpaces(articleSet.getString(16)))
                            .field("language", articleSet.getString(15))
                            .field("pages", StringUtl.getPages(articleSet.getString(7), articleSet.getString(8)))
                            .field("publisher", articleSet.getString(12))
                            .field("title", StringUtl.normalizeSpaces(articleSet.getString(3)))
                            ...
                            .field("abstract", StringUtl.normalizeSpaces(articleSet.getString(19)))
                            .field("reference", StringUtl.normalizeSpaces(articleSet.getString(20)))
                            .field("keyword", StringUtl.normalizeSpaces(articleSet.getString(21)))
